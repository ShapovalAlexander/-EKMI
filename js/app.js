(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__swiper")) new swiper_core_Swiper(".hero__swiper", {
        ...
        if (document.querySelector(".novelty__slider")) new swiper_core_Swiper(".novelty__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-prev--novelty",
                nextEl: ".swiper-button-next--novelty"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".latest__slider")) new swiper_core_Swiper(".latest__slider", {
